...
static struct device_attribute aw8697_flyme_onoff = __ATTR(on_off, 0660, NULL, aw8697_flyme_activate);
static struct device_attribute aw8697_flyme_rtp_attr = __ATTR(rtp, 0660, NULL, aw8697_flyme_rtp);
static struct device_attribute aw8697_flyme_waveform = __ATTR(waveform, 0660, NULL, aw8697_flyme_effect);
static struct device_attribute aw8697_flyme_set_rtp = __ATTR(set_rtp, 0660, NULL, aw8697_flyme_rtp);
static struct device_attribute aw8697_flyme_set_mback = __ATTR(set_mback, 0660, NULL, aw8697_flyme_strength);
static struct device_attribute aw8697_flyme_set_cspress = __ATTR(set_cspress, 0660, NULL, aw8697_flyme_strength);
static struct device_attribute aw8697_flyme_led_effect = __ATTR(effect_id, 0660, NULL, aw8697_flyme_effect);
static struct device_attribute aw8697_flyme_led_activate = __ATTR(activate, 0660, NULL, aw8697_flyme_activate);
static struct device_attribute aw8697_flyme_led_gain = __ATTR(gain, 0660, NULL, aw8697_flyme_gain);
static struct device_attribute aw8697_flyme_enable = __ATTR(enable, 0660, NULL, aw8697_flyme_timeout);
