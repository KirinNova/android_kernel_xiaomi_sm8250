...
if [ "$ENABLE_KSU" -eq 1 ]; then
    ...
    echo "==========================================="
    echo "[*] Downloading and running KernelSU remote setup script (test branch)..."
    curl -LSs "https://raw.githubusercontent.com/ReSukiSU/ReSukiSU/test/kernel/setup.sh" | bash
